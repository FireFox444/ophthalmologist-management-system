...
Public Class pt
    ...
    Private Sub pt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Displayitem()
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Date1.Enabled = True And Date2.Enabled = True Then
            con.Open()
            Dim cmd As New SqlCommand("select * from pt1 where Date between @Date1 and @Date2", con)
        ...
        If TextBox1.Enabled = True Then
            con.Open()
            Dim cmd As New SqlCommand("select * from pt1 where Name=@Name", con)
    ...
    Private Sub Pd_Print(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        e.Graphics.DrawString("Address", f10b, Brushes.Black, 120, 130)
        e.Graphics.DrawString("Age", f10b, Brushes.Black, 200, 130)
