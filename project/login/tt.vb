...
Public Class tt
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '    con.Open()
        '    Dim cmd As New SqlCommand("select * from tt1 where Date between @Date1 and @Date2", con)
        ...
        If TextBox1.Enabled = True Then
            con.Open()
            Dim cmd As New SqlCommand("select * from tt1 where name=@name", con)
    ...
    Private Sub tt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Displayitem()
    End Sub
    ...
    Private Sub Pd_Print(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        e.Graphics.DrawString("Treatment", f10b, Brushes.Black, 3, 130)
        e.Graphics.DrawString("cost", f10b, Brushes.Black, 120, 130)
        e.Graphics.DrawString("Time", f10b, Brushes.Black, 180, 130)
        ...
        For row As Integer = 0 To DataGridView1.RowCount - 1
            ...
            e.Graphics.DrawString(DataGridView1.Rows(row).Cells(1).Value.ToString, f10, Brushes.Black, 120, 140 + height)
            e.Graphics.DrawString(DataGridView1.Rows(row).Cells(2).Value.ToString, f10, Brushes.Black, 180, 140 + height)
