...
Public Class app
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If TextBox1.Enabled = True Then
            con.Open()
            Dim cmd As New SqlCommand("select * from App where Patient=@Patient", con)
    ...
    Private Sub Pd_Print(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        e.Graphics.DrawString("Name", f10b, Brushes.Black, 3, 130)
        e.Graphics.DrawString("Date", f10b, Brushes.Black, 80, 130)
        e.Graphics.DrawString("Time", f10b, Brushes.Black, 220, 130)
        e.Graphics.DrawString("Treatment", f10b, Brushes.Black, 320, 130)
        ...
        For row As Integer = 0 To DataGridView1.RowCount - 1
            ...
            e.Graphics.DrawString(DataGridView1.Rows(row).Cells(1).Value.ToString, f10, Brushes.Black, 80, 140 + height)
            e.Graphics.DrawString(DataGridView1.Rows(row).Cells(2).Value.ToString, f10, Brushes.Black, 220, 140 + height)
            e.Graphics.DrawString(DataGridView1.Rows(row).Cells(3).Value.ToString, f10, Brushes.Black, 320, 140 + height)
